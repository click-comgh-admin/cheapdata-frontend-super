        ...
        {(['tradeName', 'applicantName', 'email', 'phoneNumber', 'password', 'confirmPassword'] as FormFields[]).map((field) => (
          ...
          <div className="mt-4">
            ...
            <div className="flex justify-end space-x-2 mt-4">
              <Button className="px-4 py-2 text-xs font-medium text-background bg-teal-300 hover:bg-teal-100 rounded-md h-9 shadow focus-visible:outline-none focus-visible:ring-1">Proceed Payment</Button>
            </div>
          </div>
        </form>
      </div>
